...
print("\x1b[38;5;200m What was that?\033[0m")
print("\033[32m Thats the monster. it's been hunting here for years. The only way to stay safe is to stay inside.\033[0m")
print("\033[32m But! thats not important. I've been terribly lonely, but now you're here!\033[0m")
print("She walks away, towards the heavy double doors on the other end of the room. you notice a heavy silver key hanging around her neck ")
